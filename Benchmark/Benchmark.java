...
public abstract class Benchmark
{
    ...
    private int     anzahlThreads;         //Anzahl der verwendeten Threads
    int threadbeendet = 0;
    ...
    public Benchmark()
    {
     ...
     public void setThreadbeendet(int anzahl)
    {
       threadbeendet = anzahl; 
    }
    ...
    // Rechenlast fuer 3 Sekunden Laufzeit ermitteln
    public long lastberechnung()
    {
        ...
        double faktor = zeitmessung() / dauer;
